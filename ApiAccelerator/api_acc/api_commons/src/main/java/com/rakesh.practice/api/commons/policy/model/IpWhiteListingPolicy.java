...
public class IpWhiteListingPolicy extends Policy {
	...
	public IpWhiteListingPolicy() {
		super(PolicyType.IP_WHITELIST);
	}
	...
	public String toString() {
		return "IpWhiteListingPolicy [ipExpression=" + ipExpression + ", ipList=" + ipList + "]";
	}
